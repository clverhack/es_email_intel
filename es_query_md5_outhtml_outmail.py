...
SUBJECT = "ES Intel Report (MD5) for "+time.ctime()
...
<html lang="en">
  <head>
    ...
    <title>Newly observed MD5 indicator report</title>
  ...
  <body>
    ...
    <div class="container">
      <div class="page-header">
        <p class="lead">Here is a list of newly observed MD5 indicators from our monitored email lists.</p>
      </div>
...
for md5 in md5s:
	report_contents += '<span id="'+md5+'">'
	report_contents += '<p>============================================================================</p>'
	report_contents += '<h3>'+str(md5)+'</h3>\n'
	report_contents += '<b>Virustotal lookup:</b><br>\n<pre>'
	report_contents += external_lookups.vt_hash(md5)
