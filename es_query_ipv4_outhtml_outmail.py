...
SUBJECT = "ES Intel Report (IPv4) for "+time.ctime()
...
<html lang="en">
  <head>
    ...
    <title>Newly observed IPv4 indicator report</title>
  ...
  <body>
    ...
    <div class="container">
      <div class="page-header">
        <p class="lead">Here is a list of newly observed IPv4 indicators from our monitored email lists.</p>
      </div>
...
for ipv4 in ipv4s:
	...
	report_contents += '<p>============================================================================</p>'
	report_contents += '<h3>'+str(ipv4)+'</h3>\n'
	report_contents += '<b>FutureCrimes lookup:</b><br>\n<pre>'
	report_contents += external_lookups.ipv4_futurecrimes(ipv4)
	report_contents += '</pre><br>\n'
	report_contents += '<b>Packetmail IPRep lookup:</b><br>\n<pre>'
	report_contents += external_lookups.packetmail_lookup(ipv4)
